...
const App: React.FC = () => {
  ...
  const handleRequestQuote = (service: SecurityService) => {
          ...
          <div className="space-y-24 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <header className="text-center py-20 px-4">
              ...
              <div className="mt-14 flex flex-wrap justify-center gap-5">
                <button 
                  onClick={() => setCurrentPage(Page.Advisor)}
      ...
      case Page.Services:
        return (
          <div className="space-y-16 animate-in fade-in duration-700 px-4">
            ...
            <ServiceGrid onSelect={setSelectedService} onRequestQuote={handleRequestQuote} services={allServices} lang={lang} />
          </div>
        );
        ...
        return (
          <div className="space-y-16 animate-in fade-in duration-700 px-4">
            ...
            <div className="pt-16 border-t border-white/5">
               <ServiceGrid onSelect={setSelectedService} onRequestQuote={handleRequestQuote} services={allServices.filter(s => s.category === 'nist')} lang={lang} />
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-16 animate-in fade-in duration-700 px-4">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-12 rounded-[3rem] text-center">
               ...
               <ServiceGrid onSelect={setSelectedService} onRequestQuote={handleRequestQuote} services={allServices.filter(s => s.category === 'cloud')} lang={lang} />
            </div>
          </div>
        );
      ...
      case Page.AISecurity:
        return (
          <div className="space-y-16 animate-in fade-in duration-700 px-4">
            ...
            <div className="pt-16">
               <ServiceGrid onSelect={setSelectedService} onRequestQuote={handleRequestQuote} services={allServices.filter(s => s.category === 'ai')} lang={lang} />
            </div>
          </div>
        );
    ...
    <div className="min-h-screen pb-20 selection:bg-emerald-500 selection:text-white">
      ...
      {showQuoteSuccess && (
        <div className="fixed bottom-10 right-10 z-[200] animate-in slide-in-from-right-10 duration-500">
           <div className="glass px-10 py-5 rounded-[2rem] border-emerald-500/30 text-emerald-400 font-extrabold uppercase text-[10px] tracking-widest shadow-2xl flex items-center gap-4">
              <div className="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center text-white text-xl">✓</div>
              {t.quoteSuccess}
           </div>
        </div>
      )}
      ...
      {selectedService && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-slate-950/90 backdrop-blur-xl animate-in fade-in duration-300">
          <div className="bg-[#0f172a] border border-white/10 rounded-[3rem] w-full max-w-3xl p-12 relative shadow-4xl overflow-hidden max-h-[90vh] overflow-y-auto no-scrollbar">
            ...
            <button 
              onClick={() => {
                handleRequestQuote(selectedService);
